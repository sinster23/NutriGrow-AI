...
const translations = {
  ...
  or: {
  title: 'ଆପଣ କିପରି NutriGrow ବ୍ୟବହାର କରିବାକୁ ଚାହାଁନ୍ତି ତାହା ବାଛନ୍ତୁ',
  subtitle: 'NutriGrow AI ଆପଣଙ୍କ ଭୂମିକା ଉପରେ ଆଧାର କରି ଉପଯୁକ୍ତ ସୁପାରିଶ ପ୍ରଦାନ କରେ।',
  farmerTitle: 'କୃଷକମାନଙ୍କ ପାଇଁ',
  farmerDescription: 'ଅମଳ ଏବଂ ସ୍ଥାୟିତ୍ୱ ଉନ୍ନତ କରିବା ପାଇଁ ମାଟି, ଜଳବାୟୁ ଏବଂ ପୋଷକ ତତ୍ତ୍ୱ ଉପଲବ୍ଧତା ଉପରେ ଆଧାରିତ ଫସଲ ସୁପାରିଶ ପାଆନ୍ତୁ।',
  farmerButton: 'ଫସଲ ସୁପାରିଶ ପାଆନ୍ତୁ',
  consumerTitle: 'ଗ୍ରାହକମାନଙ୍କ ପାଇଁ',
  consumerDescription: 'ବୟସ, ସ୍ୱାସ୍ଥ୍ୟ ଅବସ୍ଥା ଏବଂ ଖାଦ୍ୟ ପସନ୍ଦ ଉପରେ ଆଧାରିତ ବ୍ୟକ୍ତିଗତ ପୋଷଣ ମାର୍ଗଦର୍ଶନ ପାଆନ୍ତୁ।',
  consumerButton: 'ପୋଷଣ ଯୋଜନା ପାଆନ୍ତୁ'
}
};
